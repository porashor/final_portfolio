...
import {testimonials} from "@/Store/demo"
...
const Testimonial = () => {
  return (
    <div className='py-3 lg:py-5 w-[90%] mx-auto'>
      ...
      <div className='py-3 lg:py-5 flex flex-wrap items-center justify-evenly gap-3'>
        {/* card */}
        {testimonials.map((testimonial, index) => (<TestimonialCard key={index} testimonials={testimonial}/>))}
      </div>
    </div>
  )
}
