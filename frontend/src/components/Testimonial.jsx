...
const Testimonial = () => {
  ...
  return (
    <div className='py-3 lg:py-5 w-[90%] mx-auto'>
      ...
      <div className='py-5 lg:py-10 block md:grid grid-cols-3 items-center justify-start gap-5 lg:gap-10 w-fit md:w-[90%] mx-auto'>
        {/* card */}
        {getloading ? Array.from({ length: 3 }).map((_, index) => <SkeletonCard key={index}/>) : allTestimonial.map((testimonial, index) => (
