  ...
  return (
    <div className="w-[350px] min-h-[400px] bg-light rounded-2xl py-10 px-3 group my-3">
      <img
        ...
        alt=""
        className="w-[80px] aspect-square object-cover mx-auto rounded-full border-4 group-hover:scale-150 group-hover:rotate-360 transition-all ease-in-out duration-1000 group-hover:-translate-y-20"
      />
      ...
      <h1 className="text-center font-bold text-2xl py-3">
        {testimonials.name || <Skeleton className="w-[200px] h-[20px]"/>}
      </h1>
